-- Category workflow status + public display flag for VoyageViet.
-- Run manually on Oracle before deploying code that removes ACTIVE/INACTIVE from CategoryStatus.
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE 'ALTER TABLE CATEGORIES ADD IS_DISPLAY NUMBER(1) DEFAULT 1 NOT NULL';
    END IF;
