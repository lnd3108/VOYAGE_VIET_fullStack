...
import com.voyageviet.backend.tour.dto.TourScheduleResponse;
...
public class PublicTourScheduleController {
    ...
    public ApiResponse<List<TourScheduleResponse>> getPublicSchedules(@PathVariable String slug) {
        return ApiResponse.success("Get public tour schedules successfully", scheduleService.getPublicSchedulesByTourSlug(slug));
    }
}
